...
<head>
    ...
    <!-- Scripts -->
    @vite(['resources/sass/app.scss', '../public/assets/css/app.css', '../public/assets/js/main.js', 'resources/js/app.js'])
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm m-0  " style="height: 70px;">
            <div class="container">
                <a class="navbar-brand row d-flex align-items-center" href="{{ url('/') }}">
                    <img class="col m-0 p-0" src="{{ asset('/assets/images/logo.png') }}" alt="" srcset=""
                        height="66">
